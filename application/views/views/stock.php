...
<head>
	...
	<link rel="stylesheet" href="http://localhost/Gotche-static/css/bootstrap.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/Gotche-static/style.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/Gotche-static/css/dark.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/Gotche-static/css/font-icons.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/Gotche-static/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/Gotche-static/css/magnific-popup.css" type="text/css" />

	<link rel="stylesheet" href="http://localhost/Gotche-static/css/responsive.css" type="text/css" />
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="sticky-style-2">
			...
			<div class="container clearfix">
				...
				============================================= -->
				<div id="logo">
					<a href="http://localhost/Gotche-static/index.php" class="standard-logo"><img src="img/logo.png" alt="Gotche Logo"></a>
					<a href="http://localhost/Gotche-static/index.php" class="retina-logo"><img src="img/logo.png" alt="Gotche Logo"></a>
				</div><!-- #logo end -->
			...
			<div id="header-wrap">
				...
				<nav id="primary-menu" class="with-arrows style-2 center">
					...
					<div class="container clearfix">
						...
						<ul>
							<li class=""><a href="http://localhost/Gotche-static/index.php" title="Home"><div>Home</div></a></li>
							<li><a href="http://localhost/Gotche-static/aboutus.php" title="About us"><div>About us</div></a></li>
							<li><a href="#" title="Products & Services"><div>Products & Services</div></a>
								<ul>
									<li><a href="http://localhost/Gotche-static/chemical-trading.php"><div>Chemical Trading</div></a></li>
									<li><a href="http://localhost/Gotche-static/indenting-business.php"><div>Indenting Business</div></a></li>
									<li><a href="http://localhost/Gotche-static/engineering-services.php"><div>Engineering Services</div></a></li>
								</ul>
							</li>
							
							<li><a href="Stock/" title="Stock"><div>Stock</div></a></li>
							<li><a href="http://localhost/Gotche-static/contactus.php" title="Contact us"><div>Contact us</div></a></li>
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" style="background-image:url(http://localhost/Gotche-static/img/stock-banner.jpg);">
<div class="container clearfix">
...
<?php } ?>
		...
		<!-- Footer
		============================================= -->
		<footer id="footer" class="dark" style="background-image:url(http://localhost/Gotche-static/img/footer-banner.jpg); border-top:0px;">
	...
	============================================= -->
	<script src="http://localhost/Gotche-static/js/jquery.js"></script>
	<script src="http://localhost/Gotche-static/js/plugins.js"></script>

	<!-- Footer Scripts
	============================================= -->
	<script src="http://localhost/Gotche-static/js/functions.js"></script>
