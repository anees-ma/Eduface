			...
			<div class="map">
				<div id="google_map" class="google_map">
					<div class="map_container">
						<div style="width: 100%"><iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=kothaparambu%2C%20kodungallur+(Eduface)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/create-google-map/">Add map to website</a></iframe></div><br />
					</div>
				</div>
			</div>
						...
						<div class="contact_form">
							<form class="comment_form contact_form">
								...
								<div>
									...
									<textarea class="comment_input comment_textarea cmessage" name="message" style="heoght:96px"></textarea>
						...
						<div class="contact_info">
							...
							<div class="contact_info_location">
								<div class="footer_contact_info">
										<ul>
											<li class="ftr-adr" style="color:#384158"><i class="fa fa-envelope" aria-hidden="true"></i> office@eduface.in</li>
											<li class="ftr-adr" style="color:#384158"><i class="fa fa-phone" aria-hidden="true"></i>  0480 2980078</li>
											<li class="ftr-adr" style="color:#384158"><i class="fa fa-mobile" aria-hidden="true"></i>  +91 85940 222 95</li>
											<li class="ftr-adr" style="color:#384158"><i class="fa fa-mobile" aria-hidden="true"></i>  +91 85940 222 97</li>
											<li class="ftr-adr" style="color:#384158"><i class="fa fa-map-marker" aria-hidden="true"></i> Kothaparambu, Kodungallur<br>
											Thrissur - Kerala</li>
										</ul>
									</div>
							</div>
